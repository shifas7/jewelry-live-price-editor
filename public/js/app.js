      ...
      async () => {
        try {
          ...
          if (data && data.success) {
            ...
            setShowRefreshModal(false);
            alert(
              "Error: Error starting refresh prices: " +
          ...
          <div className="modal" key="fallback-modal">
            <div className="modal-content" style={{ maxWidth: "500px" }}>
              <div className="modal-header">
                ...
                <button
                  className="close-btn"
                  onClick={() => handleRefreshModalClose(false)}
                >
                  ×
                </button>
              </div>
              <div style={{ padding: "20px", textAlign: "center" }}>
                {refreshJobId ? (
                  <>
                    <p>
                      <strong>Job ID:</strong> {refreshJobId}
                    </p>
                    <p
                      style={{
                        color: "#6d7175",
                    ...
                    >
                      RefreshProgressModal component not loaded. Please refresh
                      the page.
                    </p>
                  </>
                ) : (
